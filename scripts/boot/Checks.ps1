...
Function Exit-FlamePanelCord-Updater {
  $caption = ""
  $description = ""
...
Write-Host "[FlamePanelCord]: $($locales.checking_system)"

Set-Location ..
Set-Location ..

If (-Not (Test-Path ".git")) {
  Write-Host "[FlamePanelCord]: $($locales.check_failure)"
  Write-Host

  Write-Host "[FlamePanelCord]: $($locales.check_installation)"
  Write-Host "[FlamePanelCord]: $($locales.check_repo_download_method)"
  Write-Host "[FlamePanelCord]: $($locales.get_help) https://discord.gg/Corp"

  Exit-FlamePanelCord-Updater
}

Clear-Host

Write-Host "[FlamePanelCord]: $($locales.check_success)"
Write-Host

Write-Host "[FlamePanelCord]: $($locales.updating)"
Write-Host

git pull
If (-Not ($?)) {
  Write-Host "[FlamePanelCord]: $($locales.updating_failure)"
  Write-Host "[FlamePanelCord]: $($locales.get_help) https://discord.gg/Corp"
  Write-Host
...
If (-Not (Test-Path "node_modules")) {
  Write-Host "[FlamePanelCord]: Installing dependicies."
  Write-Host
