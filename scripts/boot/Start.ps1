...
If (Test-Path "..\..\index.js") {
    ...
    Write-Host "[FlamePanelCord]: $($locales.booting)"
    Write-Host
...
Else {
    ...
    Write-Host "[FlamePanelCord]: $($locales.check_index)"
    Write-Host "[FlamePanelCord]: $($locales.get_help)"
}
Write-Host
